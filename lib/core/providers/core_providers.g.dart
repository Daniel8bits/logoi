...
String _$sharedPreferencesHash() => r'4e8a47344ef19253c1d01e39006a19b5306009d4';
...
String _$fileServiceHash() => r'2488cec7a9d9f60e3a6e8754e727acdab5618406';
...
final ollamaServiceProvider = OllamaServiceProvider._();
...
String _$ollamaServiceHash() => r'4bd1fcbdd9afaec94ff972bc96ed72350a6f2ca4';
...
String _$projectRepositoryHash() => r'9f0d2210ff177fc59ff65308bdff42884e417bb5';
...
final class ThemeControllerProvider
    extends $NotifierProvider<ThemeController, LogoiThemeMode> {
  /// Global theme selection persisted in SharedPreferences.
  ...
  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(LogoiThemeMode value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<LogoiThemeMode>(value),
    );
  }
}

String _$themeControllerHash() => r'8e094901b16ee9c6309e566a7f7b3fa55fd029d0';

/// Global theme selection persisted in SharedPreferences.

abstract class _$ThemeController extends $Notifier<LogoiThemeMode> {
  LogoiThemeMode build();
  @$mustCallSuper
  @override
  WhenComplete runBuild() {
    final ref = this.ref as $Ref<LogoiThemeMode, LogoiThemeMode>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<LogoiThemeMode, LogoiThemeMode>,
              LogoiThemeMode,
              Object?,
              Object?
            >;
...
@ProviderFor(OllamaStatus)
final ollamaStatusProvider = OllamaStatusProvider._();

/// Ollama availability, checked on startup and refreshable.
final class OllamaStatusProvider
    extends $AsyncNotifierProvider<OllamaStatus, bool> {
  /// Ollama availability, checked on startup and refreshable.
  OllamaStatusProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'ollamaStatusProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$ollamaStatusHash();

  @$internal
  @override
  OllamaStatus create() => OllamaStatus();
}

String _$ollamaStatusHash() => r'0e2d8822af2c11ec46dcd9caf9699ff10f907423';

/// Ollama availability, checked on startup and refreshable.

abstract class _$OllamaStatus extends $AsyncNotifier<bool> {
  FutureOr<bool> build();
  @$mustCallSuper
  @override
  WhenComplete runBuild() {
